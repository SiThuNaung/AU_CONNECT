...
//             <button
//               onClick={() => {
//                 console.log("Feature not yet implemented yet");
//               }}
//               className="p-2.5 rounded-xl hover:bg-white hover:shadow-md transition"
//             >
...
export default function CreatePostModal({
  ...
  return (
    <main className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm px-4">
      <div className="w-full max-w-2xl bg-white rounded-3xl shadow-2xl overflow-hidden">
        ...
        {/* Media Preview */}
        {media.length > 0 && (
          <div className="relative w-full h-64 px-5 mb-6">
            {media[currentImage].type === "image" && (
              <img
                src={media[currentImage].previewUrl}
            ...
            <button
              ...
              onClick={() => {
                const url = media[currentImage].previewUrl;
